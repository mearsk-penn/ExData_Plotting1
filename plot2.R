...
# create plot (type l for lines) with x axis as days, y axis global active power
with(powerconsum, plot(powerconsum$DateTime, Global_active_power, type = "l", xlab = "", ylab = "Global Active Power (kilowatts)"))
